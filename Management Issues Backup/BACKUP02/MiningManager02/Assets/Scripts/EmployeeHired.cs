...
public class EmployeeHired : MonoBehaviour, IPointerClickHandler
{
    ...
    public static int salaryEmployeeStaticInt; // Used @ ExmployeesExtra      
    ...
    {
        if (salaryEmployeeStaticInt <= PlayerStats.totalEuroAmount)
        {
            PlayerStats.totalEuroAmount -= salaryEmployeeStaticInt;
