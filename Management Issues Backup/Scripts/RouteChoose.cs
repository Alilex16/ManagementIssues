...
public class RouteChoose : MonoBehaviour {

    List<string> routeOptions = new List<string>() { "Basic Minerals", "Interesting Mix", "Long Haul", "Dangerous Extraction", "Heavy Metals", "Shiny" };
    ...
    public void Dropdown_IndexChanged (int options)
    {
        ...
        //Debug.Log("Route number: " + options);
        //Debug.Log("Employee number: " + EmployeeExtra.employeeNumberStatic);
        ...
        if (options == 1)
        {
            ...
            //routeNumberStatic = 1;
            //Debug.Log(EmployeeExtra.employeeNumberStatic);
            //EmployeeHiring.routeTextStatic.text = EmployeeHiring.employeeStatic.route.ToString();
            //EmployeeHiring.routeTextStatic.text = "Route: First Route TEST";
            //Debug.Log(EmployeeHiring.employeeStatic.route);
            //Debug.Log(a.employeeStatic.route);
