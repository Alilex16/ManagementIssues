...
public class PlayerStats : MonoBehaviour
{
    ...
    //private static BlueprintPickaxe blueprintPickaxe = new BlueprintPickaxe();
    //public Text lastSaleText; //
    ...
    [Header("All Ingots")] // cheating // reduce all amounts to 0
    public static float ingotIronAmount = 5000;
    public static float ingotCoalAmount = 5000;
    public static float ingotTinAmount = 5000;
    public static float ingotCopperAmount = 5000;
    public static float ingotLeadAmount = 5000;
    public static float ingotSilverAmount = 5000;
    public static float ingotZincAmount = 5000;
    public static float ingotGoldAmount = 5000;
    public static float ingotTitaniumAmount = 5000;
    ...
    private void FixedUpdate()
    {
        ...
        miningLevelText.text = "Mining Level: " + BlueprintPickaxe.tierPickaxeShare.ToString(); //
        ...
        if (oreIronAmount > 0)
        {
            oreIronText.transform.parent.gameObject.SetActive(true);
        }
        else
        {
            oreIronText.transform.parent.gameObject.SetActive(false);
        }
        ...
        if (oreCoalAmount > 0)
        {
            oreCoalText.transform.parent.gameObject.SetActive(true);
        }
        else
        {
            oreCoalText.transform.parent.gameObject.SetActive(false);
        }

        if (oreCoalAmount < 100000)
        {
            oreCoalText.text = "" + oreCoalAmount.ToString("0");
        }
        else
        {
        ...
        {
            oreSilverText.text = "" + oreSilverAmount.ToString("0");
        }
        else
        {
        ...
        {
            oreZincText.text = "" + oreZincAmount.ToString("0");
        }
        else
        {
        ...
        {
            oreGoldText.text = "" + oreGoldAmount.ToString("0");
        }
        else
        {
        ...
        {
            oreTitaniumText.text = "" + oreTitaniumAmount.ToString("0");
        }
        else
        {
        ...
        {
            oreUraniumText.text = "" + oreUraniumAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotTinText.text = "" + ingotTinAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotCopperText.text = "" + ingotCopperAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotLeadText.text = "" + ingotLeadAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotSilverText.text = "" + ingotSilverAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotZincText.text = "" + ingotZincAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotGoldText.text = "" + ingotGoldAmount.ToString("0");
        }
        else
        {
        ...
        {
            ingotTitaniumText.text = "" + ingotTitaniumAmount.ToString("0");
        }
        else
        {
    ...
    [Header("Choose Route")]
    public GameObject chooseRouteMining;
    public GameObject chooseRouteForestry;

    public void EmployeeDeselected()
    {
        //a.employeeSelectedBool = false;
        chooseRouteMining.GetComponent<Dropdown>().interactable = false;
        chooseRouteForestry.GetComponent<Dropdown>().interactable = false;
    }
